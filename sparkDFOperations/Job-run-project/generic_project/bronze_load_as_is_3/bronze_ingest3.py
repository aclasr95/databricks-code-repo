...
dbutils.widgets.text("catalog","logistics_job_project")
CATALOG=dbutils.widgets.get("catalog").strip()
dbutils.widgets.text("schema","landing_schema")
...
config_nb_output = dbutils.notebook.run(
    "/Workspace/Users/aclasr@gmail.com/databricks-code-repo/sparkDFOperations/Job-run-project/generic_project/general_conf_utils_1_2/configs_path1",
...
# MAGIC %run /Workspace/Users/aclasr@gmail.com/databricks-code-repo/sparkDFOperations/Job-run-project/generic_project/general_conf_utils_1_2/util_functions2
